...
** TODO [#A] Parse Individual Messages from Chunks
*** TODO Implement ChunkParser object
*** TODO Parse chunk.messages byte array into individual messages
*** TODO Each message has length prefix + data
*** TODO Update messageHandler signature to deliver parsed messages
Current: =OsirisChunk => Unit=
Target: =(Long, Array[Byte]) => Unit= (offset, data)

** TODO [#B] Migrate to Pekko Streams TCP
...
** TODO [#B] Add Pekko Streams Integration
